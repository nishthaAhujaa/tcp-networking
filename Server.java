    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            while ((input=reader.readLine())!=null) {
                if (input.trim().toLowerCase().equals("disconnect")) {  //command
                    ...
                    socket.close();
                    break;
                }else if (input.trim().equals("integer")) { //command
